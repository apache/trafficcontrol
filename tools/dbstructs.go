...
type ApiDeliveryservice struct {
	...
	RePattern            string      `db:"re_pattern" json:"rePattern"`
	ReTypeName           string      `db:"re_type_name" json:"reTypeName"`
	ReSetNumber          null.Int    `db:"re_set_number" json:"reSetNumber"`
	SdnsHost             null.String `db:"sdns_host" json:"sdnsHost"`
	SdnsAddress          null.String `db:"sdns_address" json:"sdnsAddress"`
	SdnsTtl              null.Int    `db:"sdns_ttl" json:"sdnsTtl"`
	SdnsType             null.String `db:"sdns_type" json:"sdnsType"`
	DsTypeName           string      `db:"ds_type_name" json:"dsTypeName"`
}
...
type ContentRouters struct {
	...
	Apiport  string      `db:"apiport" json:"apiport"`
...
type CsconfigRemap struct {
	...
	DnsBypassCname       null.String `db:"dns_bypass_cname" json:"dnsBypassCname"`
	TrRequestHeaders     null.String `db:"tr_request_headers" json:"trRequestHeaders"`
	RPattern             string      `db:"r_pattern" json:"rPattern"`
