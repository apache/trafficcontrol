...
var TableCDNFederationsController = function(cdn, federations, $scope, $state, $location, locationUtils) {
	...
	$scope.editFederation = function(federation) {
		$location.path($location.path() + '/' + federation.id);
	};
...
TableCDNFederationsController.$inject = ['cdn', 'federations', '$scope', '$state', '$location', 'locationUtils'];
module.exports = TableCDNFederationsController;
