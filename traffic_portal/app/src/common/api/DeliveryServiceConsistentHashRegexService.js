...
var DeliveryServiceConsistentHashRegexService = function($http, locationUtils, messageModel, ENV) {
...
DeliveryServiceConsistentHashRegexService.$inject = ['$http', 'locationUtils', 'messageModel', 'ENV'];
