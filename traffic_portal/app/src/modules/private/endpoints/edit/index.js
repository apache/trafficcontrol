	...
	.config(function($stateProvider, $urlRouterProvider) {
		$stateProvider
			.state('trafficPortal.private.endpoints.edit', {
				...
				views: {
					endpointsContent: {
						templateUrl: 'common/modules/form/endpoint/form.endpoint.tpl.html',
						controller: 'FormEditEndpointController',
						resolve: {
							endpoint: function($stateParams, endpointService) {
								return endpointService.getEndpoint($stateParams.endpointId);
							}
						}
					}
				}
