...
module.exports = angular.module('trafficPortal.private.admin.cdns.dnssecKeys.view', [])
	.config(function($stateProvider, $urlRouterProvider) {
		$stateProvider
			.state('trafficPortal.private.admin.cdns.dnssecKeys.view', {
				url: '',
				views: {
					cdnDnssecKeysContent: {
						...
						resolve: {
							...
							dnssecKeys: function(cdn, cdnService) {
								return cdnService.getDNSSECKeys(cdn.name);
							}
						}
					}
				}
