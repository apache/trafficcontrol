	...
	.config(function($stateProvider, $urlRouterProvider) {
		$stateProvider
			.state('trafficPortal.private.deliveryServices.staticDnsEntries.list', {
				url: '',
				views: {
					deliveryServicesStaticDnsEntriesContent: {
						...
						resolve: {
							...
							staticDnsEntries: function($stateParams, deliveryServiceStaticDnsEntryService) {
								return deliveryServiceStaticDnsEntryService.getStaticDnsEntries({ deliveryserviceId: $stateParams.deliveryServiceId });
							}
						}
					}
				}
