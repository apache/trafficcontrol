...
module.exports = angular.module('trafficPortal.private.deliveryServices.capabilities', [])
				...
				views: {
					deliveryServicesContent: {
						...
						resolve: {
							...
							requiredCapabilities: function($stateParams, deliveryServiceService) {
								return deliveryServiceService.getDeliveryServiceCapabilities($stateParams.deliveryServiceId);
							}
						}
					}
				}
