...
module.exports = angular.module('trafficPortal.private.deliveryServices.jobs', [])
	...
	.config(function($stateProvider, $urlRouterProvider) {
		$stateProvider
			.state('trafficPortal.private.deliveryServices.jobs', {
				url: '/{deliveryServiceId}/jobs?dsType',
				abstract: true,
				views: {
					deliveryServicesContent: {
						templateUrl: 'modules/private/deliveryServices/jobs/deliveryServiceJobs.tpl.html',
