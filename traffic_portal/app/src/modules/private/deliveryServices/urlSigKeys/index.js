...
module.exports = angular.module('trafficPortal.private.deliveryServices.urlSigKeys', [])
	.controller('DeliveryServiceUrlSigKeysController', require('./DeliveryServiceUrlSigKeysController'))
	.config(function($stateProvider, $urlRouterProvider) {
		$stateProvider
			.state('trafficPortal.private.deliveryServices.urlSigKeys', {
				url: '/{deliveryServiceId}/url-sig-keys',
				views: {
					deliveryServicesContent: {
						templateUrl: 'modules/private/deliveryServices/urlSigKeys/deliveryServiceUrlSigKeys.tpl.html',
