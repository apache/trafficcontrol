...
module.exports = angular.module('trafficPortal.private.cdns.config', [])
	.controller('ConfigController', require('./ConfigController'))
	.config(function($stateProvider, $urlRouterProvider) {
		$stateProvider
			.state('trafficPortal.private.cdns.config', {
				url: '/{cdnId}/config/changes',
				views: {
					cdnsContent: {
						templateUrl: 'modules/private/cdns/config/config.tpl.html',
