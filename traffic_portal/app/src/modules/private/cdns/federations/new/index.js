...
module.exports = angular.module('trafficPortal.private.cdns.federations.new', [])
	.config(function($stateProvider, $urlRouterProvider) {
		$stateProvider
			.state('trafficPortal.private.cdns.federations.new', {
				url: '/new',
				views: {
					cdnFederationsContent: {
						templateUrl: 'common/modules/form/federation/form.federation.tpl.html',
						controller: 'FormNewFederationController',
						resolve: {
