...
var trafficPortal = angular.module('trafficPortal', [
        ...
        require('./modules/private/admin/cdns/dnssecKeys').name,
        require('./modules/private/admin/cdns/dnssecKeys/generate').name,
        require('./modules/private/admin/cdns/dnssecKeys/view').name,
