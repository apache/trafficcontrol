...
func getTestTypesV5() []tc.TypeNullableV5 {
	types := []tc.TypeNullableV5{}
	ID := 1
	name := "name1"
	description := "desc"
	useInTable := "use_in_table1"
	lastUpdated := time.Now()
	testCase := tc.TypeNullableV5{
		ID:          &ID,
...
func TestGetTypeV5(t *testing.T) {
	...
	cols := test.ColsFromStructByTag("db", tc.TypeNullableV5{})
...
func createDummyTypeV5(field string) *TOTypeV5 {
	version := api.Version{
		Major: 2,
		Minor: 0,
	}
	...
	return &TOTypeV5{
		TypeNullableV5: tc.TypeNullableV5{
			Name:        &field,
			Description: &field,
			UseInTable:  &field,
		},
...
func TestUpdateInvalidTypeV5(t *testing.T) {
	invalidUpdateType := createDummyTypeV5("test")
...
func TestDeleteInvalidTypeV5(t *testing.T) {
	invalidDeleteType := createDummyTypeV5("other")
...
func TestCreateInvalidTypeV5(t *testing.T) {
	invalidCreateType := createDummyTypeV5("test")
