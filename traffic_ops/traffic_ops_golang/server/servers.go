...
func getServers(apiMajorVersion uint64, params map[string]string, tx *sqlx.Tx, user *auth.CurrentUser) ([]tc.ServerNullable, error, error, int) {
	...
	searchQueryParamsToSQLCols := map[string]dbhelpers.WhereColumnInfo{
		...
		"cdnName":       dbhelpers.WhereColumnInfo{"cdn.name", nil},
		"domainName":    dbhelpers.WhereColumnInfo{"s.domain_name", nil},
		"hostName":      dbhelpers.WhereColumnInfo{"s.host_name", nil},
		"iloIpAddress":  dbhelpers.WhereColumnInfo{"s.ilo_ip_address", nil},
		"iloIpNetmask":  dbhelpers.WhereColumnInfo{"s.ilo_ip_netmask", nil},
		"iloIpGateway":  dbhelpers.WhereColumnInfo{"s.ilo_ip_gateway", nil},
		"iloUsername":   dbhelpers.WhereColumnInfo{"s.ilo_username", nil},
		"mgmtIpAddress": dbhelpers.WhereColumnInfo{"s.mgmt_ip_address", nil},
		"mgmtIpNetmask": dbhelpers.WhereColumnInfo{"s.mgmt_ip_netmask", nil},
		"mgmtIpGateway": dbhelpers.WhereColumnInfo{"s.mgmt_ip_gateway", nil},
		"ipAddress":     dbhelpers.WhereColumnInfo{"s.ip_address", nil},
		"ipNetmask":     dbhelpers.WhereColumnInfo{"s.ip_netmask", nil},
		"ipGateway":     dbhelpers.WhereColumnInfo{"s.ip_gateway", nil},
		"ip6Address":    dbhelpers.WhereColumnInfo{"s.ip6_address", nil},
		"ip6Gateway":    dbhelpers.WhereColumnInfo{"s.ip6_gateway", nil},
		"interfaceName": dbhelpers.WhereColumnInfo{"s.interface_name", nil},
