...
func GetSSLMultiCertDSesInfo(tx *sql.Tx, cdn tce.CDNName) (map[tce.DeliveryServiceName]SSLMultiCertDSInfo, error) {
	dses := map[tce.DeliveryServiceName]SSLMultiCertDSInfo{}
	qry := `
SELECT
  ds.xml_id,
...
func GetSSLMultiCertDSes(tx *sql.Tx, cdn tce.CDNName) (map[tce.DeliveryServiceName]atscfg.SSLMultiCertDS, error) {
	...
	dses := map[tce.DeliveryServiceName]atscfg.SSLMultiCertDS{}
