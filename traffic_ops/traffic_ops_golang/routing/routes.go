...
func Routes(d ServerData) ([]Route, []RawRoute, http.Handler, error) {
	...
	routes := []Route{
		...
		{1.1, http.MethodDelete, `federation_resolvers(/|\.json)?$`, federation_resolvers.Delete, auth.PrivLevelAdmin, Authenticated, nil, 9001, perlBypass},
		{1.4, http.MethodDelete, `federation_resolvers/?`, federation_resolvers.Delete, auth.PrivLevelAdmin, Authenticated, nil, 9001, perlBypass},
