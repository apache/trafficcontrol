...
func Routes(d ServerData) ([]Route, []RawRoute, http.Handler, error) {
	...
	routes := []Route{
		...
		// Foos
		{1.9, http.MethodGet, `foos/?(\.json)?$`, api.ReadHandler(&foo.TOFoo{}), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.8, http.MethodGet, `foos/?(\.json)?$`, api.ReadHandler(&foo.TOFoo{}), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.7, http.MethodGet, `foos/?(\.json)?$`, api.ReadHandler(&foo.TOFoo{}), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.6, http.MethodGet, `foos/?(\.json)?$`, api.ReadHandler(&foo.TOFoo{}), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.5, http.MethodGet, `foos/?(\.json)?$`, api.ReadHandler(&foo.TOFoo{}), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.9, http.MethodGet, `foos/{id}/?(\.json)?$`, api.ReadHandler(&foo.TOFoo{}), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.8, http.MethodGet, `foos/{id}/?(\.json)?$`, api.ReadHandler(&foo.TOFoo{}), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.7, http.MethodGet, `foos/{id}/?(\.json)?$`, api.ReadHandler(&foo.TOFoo{}), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.6, http.MethodGet, `foos/{id}/?(\.json)?$`, api.ReadHandler(&foo.TOFoo{}), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.5, http.MethodGet, `foos/{id}/?(\.json)?$`, api.ReadHandler(&foo.TOFoo{}), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.9, http.MethodPost, `foos/?(\.json)?$`, foo.Create, auth.PrivLevelOperations, Authenticated, nil},
		{1.8, http.MethodPost, `foos/?(\.json)?$`, foo.Create, auth.PrivLevelOperations, Authenticated, nil},
		{1.7, http.MethodPost, `foos/?(\.json)?$`, foo.Create, auth.PrivLevelOperations, Authenticated, nil},
		{1.6, http.MethodPost, `foos/?(\.json)?$`, foo.Create, auth.PrivLevelOperations, Authenticated, nil},
		{1.5, http.MethodPost, `foos/?(\.json)?$`, foo.Create, auth.PrivLevelOperations, Authenticated, nil},
		{1.9, http.MethodPut, `foos/{id}/?(\.json)?$`, foo.Update, auth.PrivLevelOperations, Authenticated, nil},
		{1.8, http.MethodPut, `foos/{id}/?(\.json)?$`, foo.Update, auth.PrivLevelOperations, Authenticated, nil},
		{1.7, http.MethodPut, `foos/{id}/?(\.json)?$`, foo.Update, auth.PrivLevelOperations, Authenticated, nil},
		{1.6, http.MethodPut, `foos/{id}/?(\.json)?$`, foo.Update, auth.PrivLevelOperations, Authenticated, nil},
