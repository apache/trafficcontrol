...
func Routes(d ServerData) ([]Route, http.Handler, error) {
	...
	routes := []Route{
		...
		{Version: api.Version{Major: 5, Minor: 0}, Method: http.MethodDelete, Path: `OC/CI/configuration/?$`, Handler: cdni.DeleteConfiguration, RequiredPrivLevel: auth.PrivLevelAdmin, RequiredPermissions: []string{"CDNI-CAPACITY:UPDATE"}, Authenticated: Authenticated, Middlewares: nil, ID: 5413577290782},
