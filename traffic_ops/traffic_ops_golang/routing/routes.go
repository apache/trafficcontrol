...
import (
	...
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/about"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/acme"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/api"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/apicapability"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/apitenant"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/asn"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/auth"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/cachegroup"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/cachegroupparameter"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/cachesstats"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/capabilities"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/cdn"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/cdn_lock"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/cdnfederation"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/cdnnotification"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/coordinate"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/crconfig"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/crstats"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/dbdump"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/deliveryservice"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/deliveryservice/consistenthash"
	dsrequest "github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/deliveryservice/request"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/deliveryservice/request/comment"
	dsserver "github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/deliveryservice/servers"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/deliveryservicerequests"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/deliveryservicesregexes"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/division"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/federation_resolvers"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/federations"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/invalidationjobs"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/iso"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/login"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/logs"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/origin"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/parameter"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/physlocation"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/ping"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/plugins"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/profile"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/profileparameter"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/region"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/role"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/server"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/servercapability"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/servercheck"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/servercheck/extensions"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/servicecategory"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/staticdnsentry"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/status"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/steering"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/steeringtargets"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/systeminfo"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/topology"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/trafficstats"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/types"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/urisigning"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/user"
	"github.com/apache/trafficcontrol/v6/traffic_ops/traffic_ops_golang/vault"
...
func Routes(d ServerData) ([]Route, http.Handler, error) {
	...
	routes := []Route{
		...
		{api.Version{Major: 4, Minor: 0}, http.MethodPost, `users/register/?$`, login.RegisterUser, auth.PrivLevelOperations, nil, Authenticated, nil, 43373},

		//ISO
		{api.Version{Major: 4, Minor: 0}, http.MethodGet, `osversions/?$`, iso.GetOSVersions, auth.PrivLevelReadOnly, nil, Authenticated, nil, 4760886573},
		...
		{api.Version{Major: 4, Minor: 0}, http.MethodPost, `servercheck/extensions$`, extensions.Create, auth.PrivLevelReadOnly, nil, Authenticated, nil, 4804985993},
		{api.Version{Major: 4, Minor: 0}, http.MethodGet, `servercheck/extensions$`, extensions.Get, auth.PrivLevelReadOnly, nil, Authenticated, nil, 4834985993},
		{api.Version{Major: 4, Minor: 0}, http.MethodDelete, `servercheck/extensions/{id}$`, extensions.Delete, auth.PrivLevelReadOnly, nil, Authenticated, nil, 4804982993},

		//Server Details
		{api.Version{Major: 4, Minor: 0}, http.MethodGet, `servers/details/?$`, server.GetDetailParamHandler, auth.PrivLevelReadOnly, nil, Authenticated, nil, 42612647143},

		//Server status
		{api.Version{Major: 4, Minor: 0}, http.MethodPut, `servers/{id}/status$`, server.UpdateStatusHandler, auth.PrivLevelOperations, nil, Authenticated, nil, 4766638513},
		{api.Version{Major: 4, Minor: 0}, http.MethodPost, `servers/{id}/queue_update$`, server.QueueUpdateHandler, auth.PrivLevelOperations, nil, Authenticated, nil, 41894713},
		{api.Version{Major: 4, Minor: 0}, http.MethodGet, `servers/{host_name}/update_status$`, server.GetServerUpdateStatusHandler, auth.PrivLevelReadOnly, nil, Authenticated, nil, 4384515993},
		{api.Version{Major: 4, Minor: 0}, http.MethodPost, `servers/{id-or-name}/update$`, server.UpdateHandler, auth.PrivLevelOperations, nil, Authenticated, nil, 443813233},

		//Server: CRUD
		{api.Version{Major: 4, Minor: 0}, http.MethodGet, `servers/?$`, server.Read, auth.PrivLevelReadOnly, nil, Authenticated, nil, 47209592853},
		{api.Version{Major: 4, Minor: 0}, http.MethodPut, `servers/{id}$`, server.Update, auth.PrivLevelOperations, nil, Authenticated, nil, 4586341033},
		{api.Version{Major: 4, Minor: 0}, http.MethodPost, `servers/?$`, server.Create, auth.PrivLevelOperations, nil, Authenticated, nil, 42255580613},
		...
		// Federations
		{api.Version{Major: 4, Minor: 0}, http.MethodGet, `federations/all/?$`, federations.GetAll, auth.PrivLevelAdmin, nil, Authenticated, nil, 410599863},
		{api.Version{Major: 4, Minor: 0}, http.MethodGet, `federations/?$`, federations.Get, auth.PrivLevelFederation, nil, Authenticated, nil, 4549549943},
		{api.Version{Major: 4, Minor: 0}, http.MethodPost, `federations/?$`, federations.AddFederationResolverMappingsForCurrentUser, auth.PrivLevelFederation, nil, Authenticated, nil, 48940647423},
		...
		// Plugins
		{api.Version{Major: 4, Minor: 0}, http.MethodGet, `plugins/?$`, plugins.Get(d.Plugins), auth.PrivLevelReadOnly, nil, Authenticated, nil, 4834985393},
