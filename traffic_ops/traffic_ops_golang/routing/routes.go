...
func Routes(d ServerData) ([]Route, []RawRoute, http.Handler, error) {
	...
	routes := []Route{
		...
		//ISO
		{1.1, http.MethodGet, `osversions(/|\.json)?$`, iso.GetOSVersions, auth.PrivLevelReadOnly, Authenticated, nil},
		...
		{1.5, http.MethodPost, `deliveryservices/{ds-name}/snapshot/?$`, crconfig.SnapshotDSHandler, auth.PrivLevelOperations, Authenticated, nil},
