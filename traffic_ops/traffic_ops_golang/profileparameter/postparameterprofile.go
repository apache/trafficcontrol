...
func PostParamProfile(w http.ResponseWriter, r *http.Request) {
	...
	api.CreateChangeLogRawTx("PARAM: "+paramName+", ID: "+strconv.FormatInt(*paramProfile.ParamID, 10)+", ACTION: Assigned "+strconv.Itoa(len(*paramProfile.ProfileIDs))+" profiles to parameter", inf.User, inf.Tx.Tx)
