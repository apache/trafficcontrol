...
func (ds TODeliveryServiceV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(ds.DeliveryServiceNullableV14)
}

func (ds *TODeliveryServiceV14) UnmarshalJSON(data []byte) error {
	return json.Unmarshal(data, ds.DeliveryServiceNullableV14)
}
...
func (ds *TODeliveryServiceV14) Validate() error {
	return ds.DeliveryServiceNullableV14.Validate(ds.APIInfo().Tx.Tx)
}
...
func CreateV14(w http.ResponseWriter, r *http.Request) {
	...
	tcDS := tc.NewDeliveryServiceNullableFromV14(ds)
