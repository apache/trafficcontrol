...
func AddSSLKeys(w http.ResponseWriter, r *http.Request) {
	...
	api.CreateChangeLogRawTx("DS: "+*req.DeliveryService+", ID: "+strconv.Itoa(dsID)+", ACTION: Added/Updated SSL keys", inf.User, inf.Tx.Tx)
...
func DeleteSSLKeys(w http.ResponseWriter, r *http.Request) {
	...
	api.CreateChangeLogRawTx("DS: "+xmlID+", ID: "+strconv.Itoa(dsID)+", ACTION: Deleted SSL keys", inf.User, inf.Tx.Tx)
