...
func CopyURLKeys(w http.ResponseWriter, r *http.Request) {
	...
	api.CreateChangeLogRawTx("DS: "+string(ds)+", ID: "+strconv.Itoa(dsID)+", ACTION: Copied URL sig keys from "+string(copyDS), inf.User, inf.Tx.Tx)
...
func GenerateURLKeys(w http.ResponseWriter, r *http.Request) {
	...
	api.CreateChangeLogRawTx("DS: "+string(ds)+", ID: "+strconv.Itoa(dsID)+", ACTION: Generated URL sig keys", inf.User, inf.Tx.Tx)
...
func DeleteURLKeysByID(w http.ResponseWriter, r *http.Request) {
	...
	api.CreateChangeLogRawTx("DS: "+string(ds)+", ID: "+strconv.Itoa(dsId)+", ACTION: Deleted URL sig keys", inf.User, inf.Tx.Tx)
