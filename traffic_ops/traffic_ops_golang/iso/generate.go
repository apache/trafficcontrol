...
func (i *isoRequest) equal(other isoRequest) bool {
	if i.OSVersionDir != other.OSVersionDir {
		return false
	}
	if i.HostName != other.HostName {
		return false
	}
	if i.DomainName != other.DomainName {
		return false
	}
	if i.RootPass != other.RootPass {
		return false
	}
	if i.DHCP != other.DHCP {
		return false
	}
	if !i.IPAddr.Equal(other.IPAddr) {
		return false
	}
	if !i.IPNetmask.Equal(other.IPNetmask) {
		return false
	}
	if !i.IPGateway.Equal(other.IPGateway) {
		return false
	}
	if !i.IP6Address.Equal(other.IP6Address) {
		return false
	}
	if !i.IP6Gateway.Equal(other.IP6Gateway) {
		return false
	}
	if i.InterfaceName != other.InterfaceName {
		return false
	}
	if i.InterfaceMTU != other.InterfaceMTU {
		return false
	}
	if i.Disk != other.Disk {
		return false
	}
	if !i.MgmtIPAddress.Equal(other.MgmtIPAddress) {
		return false
	}
	if !i.MgmtIPNetmask.Equal(other.MgmtIPNetmask) {
		return false
	}
	if !i.MgmtIPGateway.Equal(other.MgmtIPGateway) {
		return false
	}
	if i.MgmtInterface != other.MgmtInterface {
		return false
	}
	if i.Stream != other.Stream {
		return false
	}
	return true
}
...
// boolStr wraps a boolean value with JSON decoding
// allowing for the value to be a string, eg "yes", "no".
