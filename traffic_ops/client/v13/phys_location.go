...
func (to *Session) CreatePhysLocation(pl tc.PhysLocation) (common.Alerts, ReqInf, error) {
...
func (to *Session) UpdatePhysLocationByID(id int, pl tc.PhysLocation) (common.Alerts, ReqInf, error) {
