...
// Create a CDN
func (to *Session) CreateCDN(cdn tc.CDN) (common.Alerts, ReqInf, error) {
...
// Update a CDN by ID
func (to *Session) UpdateCDNByID(id int, cdn tc.CDN) (common.Alerts, ReqInf, error) {
...
// DELETE a CDN by ID
func (to *Session) DeleteCDNByID(id int) (common.Alerts, ReqInf, error) {
	route := fmt.Sprintf("%s/%d", API_v12_CDNs, id)
