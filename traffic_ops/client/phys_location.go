...
func (to *Session) CreatePhysLocation(physLocation tc.PhysLocation) (common.Alerts, ReqInf, error) {
...
func (to *Session) UpdatePhysLocationByID(id int, physLocation tc.PhysLocation) (common.Alerts, ReqInf, error) {
...
func (to *Session) DeletePhysLocationByID(id int) (common.Alerts, ReqInf, error) {
	route := fmt.Sprintf("%s/%d", API_v13_PHYS_LOCATIONS, id)
