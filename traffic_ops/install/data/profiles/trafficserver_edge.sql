...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.extended2_log_is_ascii' and config_file = 'records.config' and value = 'INT 1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.extended2_log_name' and config_file = 'records.config' and value = 'STRING extended2') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.extended_log_enabled' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.extended_log_header' and config_file = 'records.config' and value = 'STRING NULL') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.extended_log_is_ascii' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.extended_log_name' and config_file = 'records.config' and value = 'STRING extended') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.hostname' and config_file = 'records.config' and value = 'STRING localhost') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.logfile_dir' and config_file = 'records.config' and value = 'STRING var/log/trafficserver') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.logfile_perm' and config_file = 'records.config' and value = 'STRING rw-r--r--') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.logging_enabled' and config_file = 'records.config' and value = 'INT 3') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.max_secs_per_buffer' and config_file = 'records.config' and value = 'INT 5') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.max_space_mb_for_logs' and config_file = 'records.config' and value = 'INT 25000') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.max_space_mb_for_orphan_logs' and config_file = 'records.config' and value = 'INT 25') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.max_space_mb_headroom' and config_file = 'records.config' and value = 'INT 1000') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.rolling_enabled' and config_file = 'records.config' and value = 'INT 1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.rolling_interval_sec' and config_file = 'records.config' and value = 'INT 86400') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.rolling_offset_hr' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.rolling_size_mb' and config_file = 'records.config' and value = 'INT 10') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.sampling_frequency' and config_file = 'records.config' and value = 'INT 1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.separate_host_logs' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.separate_icp_logs' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.squid_log_enabled' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.squid_log_header' and config_file = 'records.config' and value = 'STRING NULL') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.squid_log_is_ascii' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.squid_log_name' and config_file = 'records.config' and value = 'STRING squid') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.log.xml_config_file' and config_file = 'records.config' and value = 'STRING logs_xml.config') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.mlock_enabled' and config_file = 'records.config' and value = 'INT 2') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.net.connections_throttle' and config_file = 'records.config' and value = 'INT 500000') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.net.default_inactivity_timeout' and config_file = 'records.config' and value = 'INT 180') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.net.defer_accept' and config_file = 'records.config' and value = 'INT 45') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.net.sock_recv_buffer_size_in' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.net.sock_recv_buffer_size_out' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.net.sock_send_buffer_size_in' and config_file = 'records.config' and value = 'INT 262144') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.net.sock_send_buffer_size_out' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.output.logfile' and config_file = 'records.config' and value = 'STRING traffic.out') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.process_manager.mgmt_port' and config_file = 'records.config' and value = 'INT 8084') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.proxy_binary_opts' and config_file = 'records.config' and value = 'STRING -M') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.proxy_name' and config_file = 'records.config' and value = 'STRING __HOSTNAME__') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.reverse_proxy.enabled' and config_file = 'records.config' and value = 'INT 1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.snapshot_dir' and config_file = 'records.config' and value = 'STRING snapshots') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.CA.cert.filename' and config_file = 'records.config' and value = 'STRING NULL') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.CA.cert.path' and config_file = 'records.config' and value = 'STRING etc/trafficserver/ssl') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.client.CA.cert.filename' and config_file = 'records.config' and value = 'STRING NULL') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.client.CA.cert.path' and config_file = 'records.config' and value = 'STRING etc/trafficserver/ssl') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.client.cert.filename' and config_file = 'records.config' and value = 'STRING NULL') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.client.certification_level' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.client.cert.path' and config_file = 'records.config' and value = 'STRING etc/trafficserver/ssl') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.client.private_key.filename' and config_file = 'records.config' and value = 'STRING NULL') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.client.private_key.path' and config_file = 'records.config' and value = 'STRING etc/trafficserver/ssl') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.client.verify.server' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.compression' and config_file = 'records.config' and value = 'INT 1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.number.threads' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.server.cert_chain.filename' and config_file = 'records.config' and value = 'STRING NULL') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.server.cert.path' and config_file = 'records.config' and value = 'STRING etc/trafficserver/ssl') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.server.cipher_suite' and config_file = 'records.config' and value = 'STRING ECDHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-AES128-SHA256:ECDHE-RSA-AES256-SHA384:AES128-GCM-SHA256:AES256-GCM-SHA384:ECDHE-RSA-RC4-SHA:ECDHE-RSA-AES128-SHA:ECDHE-RSA-AES256-SHA:RC4-SHA:RC4-MD5:AES128-SHA:AES256-SHA:DES-CBC3-SHA!SRP:!DSS:!PSK:!aNULL:!eNULL:!SSLv2') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.server.honor_cipher_order' and config_file = 'records.config' and value = 'INT 1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.server.multicert.filename' and config_file = 'records.config' and value = 'STRING ssl_multicert.config') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.server.private_key.path' and config_file = 'records.config' and value = 'STRING etc/trafficserver/ssl') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.SSLv2' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.SSLv3' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.ssl.TLSv1' and config_file = 'records.config' and value = 'INT 1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.stack_dump_enabled' and config_file = 'records.config' and value = 'INT 1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.syslog_facility' and config_file = 'records.config' and value = 'STRING LOG_DAEMON') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.system.mmap_max' and config_file = 'records.config' and value = 'INT 2097152') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.task_threads' and config_file = 'records.config' and value = 'INT 2') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.temp_dir' and config_file = 'records.config' and value = 'STRING /tmp') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.update.concurrent_updates' and config_file = 'records.config' and value = 'INT 100') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.update.enabled' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.update.force' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.update.retry_count' and config_file = 'records.config' and value = 'INT 10') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.update.retry_interval' and config_file = 'records.config' and value = 'INT 2') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.url_remap.default_to_server_pac' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.url_remap.default_to_server_pac_port' and config_file = 'records.config' and value = 'INT -1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.url_remap.filename' and config_file = 'records.config' and value = 'STRING remap.config') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.url_remap.pristine_host_hdr' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('CONFIG proxy.config.url_remap.remap_required','records.config','INT 1') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'CONFIG proxy.config.url_remap.remap_required' and config_file = 'records.config' and value = 'INT 1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'Disk_Volume' and config_file = 'storage.config' and value = '1') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'Drive_Letters' and config_file = 'storage.config' and value = 'b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'Drive_Prefix' and config_file = 'storage.config' and value = '/dev/sd') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('header_rewrite.so','plugin.config','/opt/trafficserver/etc/trafficserver/8080_fwd.config') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'header_rewrite.so' and config_file = 'plugin.config' and value = '/opt/trafficserver/etc/trafficserver/8080_fwd.config') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'health.connection.timeout' and config_file = 'rascal.properties' and value = '2000') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'health.polling.url' and config_file = 'rascal.properties' and value = 'http://${hostname}/_astats?application=&inf.name=${interface_name}') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'health.threshold.availableBandwidthInKbps' and config_file = 'rascal.properties' and value = '>1750000') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'health.threshold.loadavg' and config_file = 'rascal.properties' and value = '25.0') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'health.threshold.queryTime' and config_file = 'rascal.properties' and value = '1000') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'history.count' and config_file = 'rascal.properties' and value = '30') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('line1','8080_fwd.config','cond %{READ_REQUEST_HDR_HOOK}') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'line1' and config_file = '8080_fwd.config' and value = 'cond %{READ_REQUEST_HDR_HOOK}') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('line2','8080_fwd.config','cond %{INCOMING-PORT} =8080') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'line2' and config_file = '8080_fwd.config' and value = 'cond %{INCOMING-PORT} =8080') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('line3','8080_fwd.config','skip-remap true') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'line3' and config_file = '8080_fwd.config' and value = 'skip-remap true') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'LOCAL proxy.config.cache.interim.storage' and config_file = 'records.config' and value = 'STRING NULL') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'LOCAL proxy.local.cluster.type' and config_file = 'records.config' and value = 'INT 3') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'LOCAL proxy.local.log.collation_mode' and config_file = 'records.config' and value = 'INT 0') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_30.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_30.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_34.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_34.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_36.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_36.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_38.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_38.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_8.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_8.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = '12M_facts' and value = '/opt/ort') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_16.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_16.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_24.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_24.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_32.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_32.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_40.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_40.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_26.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_26.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'astats.config' and value = '/opt/trafficserver/etc/trafficserver') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','drop_qstring.config','/opt/trafficserver/etc/trafficserver') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'drop_qstring.config' and value = '/opt/trafficserver/etc/trafficserver') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'regex_revalidate.config' and value = '/opt/trafficserver/etc/trafficserver') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_0.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_0.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_10.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_10.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_12.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_12.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_14.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_14.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_18.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_18.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_20.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_20.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_22.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_22.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_28.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_28.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_48.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_48.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'logs_xml.config' and value = '/opt/trafficserver/etc/trafficserver') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_56.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_56.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','8080_fwd.config','/opt/trafficserver/etc/trafficserver') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = '8080_fwd.config' and value = '/opt/trafficserver/etc/trafficserver') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','ssl_multicert.config','/opt/trafficserver/etc/trafficserver') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'ssl_multicert.config' and value = '/opt/trafficserver/etc/trafficserver') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','bg_fetch.config','/opt/trafficserver/etc/trafficserver') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'bg_fetch.config' and value = '/opt/trafficserver/etc/trafficserver') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'cacheurl_qstring.config' and value = '/opt/trafficserver/etc/trafficserver') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('location','set_dscp_37.config','/opt/trafficserver/etc/trafficserver/dscp') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'set_dscp_37.config' and value = '/opt/trafficserver/etc/trafficserver/dscp') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'ip_allow.config' and value = '/opt/trafficserver/etc/trafficserver') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = '50-ats.rules' and value = '/etc/udev/rules.d/') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'volume.config' and value = '/opt/trafficserver/etc/trafficserver/') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'storage.config' and value = '/opt/trafficserver/etc/trafficserver/') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'remap.config' and value = '/opt/trafficserver/etc/trafficserver/') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'records.config' and value = '/opt/trafficserver/etc/trafficserver/') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'plugin.config' and value = '/opt/trafficserver/etc/trafficserver/') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'parent.config' and value = '/opt/trafficserver/etc/trafficserver/') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'location' and config_file = 'hosting.config' and value = '/opt/trafficserver/etc/trafficserver/') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'LogObject.Filename' and config_file = 'logs_xml.config' and value = 'custom_ats_2') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'LogObject.Format' and config_file = 'logs_xml.config' and value = 'custom_ats_2') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'LogObject.RollingEnabled' and config_file = 'logs_xml.config' and value = '3') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'LogObject.RollingIntervalSec' and config_file = 'logs_xml.config' and value = '86400') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'LogObject.RollingOffsetHr' and config_file = 'logs_xml.config' and value = '11') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'LogObject.RollingSizeMb' and config_file = 'logs_xml.config' and value = '1024') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'maxRevalDurationDays' and config_file = 'regex_revalidate.config' and value = '90') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'path' and config_file = 'astats.config' and value = '_astats') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('qstring','parent.config','ignore') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'qstring' and config_file = 'parent.config' and value = 'ignore') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'RAM_Drive_Letters' and config_file = 'storage.config' and value = '0,1,2,3,4,5,6,7') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'RAM_Drive_Prefix' and config_file = 'storage.config' and value = '/dev/ram') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'RAM_Volume' and config_file = 'storage.config' and value = '2') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'record_types' and config_file = 'astats.config' and value = '122') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'regex_revalidate.so' and config_file = 'plugin.config' and value = '--config regex_revalidate.config') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('remap_stats.so','plugin.config','') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'remap_stats.so' and config_file = 'plugin.config' and value = '') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('stale_while_revalidate.so','plugin.config','--log-stale-if-error --log-filename stale.log') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'stale_while_revalidate.so' and config_file = 'plugin.config' and value = '--log-stale-if-error --log-filename stale.log') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('trafficserver','package','6.2.1-45.109c42b.el7.centos.x86_64') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'trafficserver' and config_file = 'package' and value = '6.2.1-45.109c42b.el7.centos.x86_64') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'trafficserver' and config_file = 'chkconfig' and value = '0:off	1:off	2:on	3:on	4:on	5:on	6:off') )  ON CONFLICT (profile, parameter) DO NOTHING;

INSERT INTO parameter (name, config_file, value) VALUES ('trafficserver-debuginfo','package','6.2.1-45.109c42b.el7.centos.x86_64') ON CONFLICT (name,config_file, value) DO NOTHING;
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'trafficserver-debuginfo' and config_file = 'package' and value = '6.2.1-45.109c42b.el7.centos.x86_64') )  ON CONFLICT (profile, parameter) DO NOTHING;
...
INSERT INTO profile_parameter (profile, parameter) VALUES ( (select id from profile where name = 'EDGE_PROFILE'), (select id from parameter where name = 'weight' and config_file = 'CRConfig.json' and value = '1.0') )  ON CONFLICT (profile, parameter) DO NOTHING;
