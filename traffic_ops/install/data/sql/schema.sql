...
--
-- Table structure for table `deliveryservice_extuser`
--

DROP TABLE IF EXISTS `deliveryservice_extuser`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `deliveryservice_extuser` (
  `deliveryservice` int(11) NOT NULL,
  `ext_user` int(11) NOT NULL,
  `last_updated` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`deliveryservice`,`ext_user`),
  KEY `fk_job_user` (`ext_user`),
  CONSTRAINT `fk_ext_user` FOREIGN KEY (`ext_user`) REFERENCES `ext_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_ds` FOREIGN KEY (`deliveryservice`) REFERENCES `deliveryservice` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `deliveryservice_regex`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `deliveryservice_server`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `deliveryservice_tmuser`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `header_rewrite`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2469167 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `job` (
  ...
  CONSTRAINT `fk_job_user_id1` FOREIGN KEY (`job_user`) REFERENCES `ext_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
DROP TABLE IF EXISTS `location_parameter`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15892 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `phys_location`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `profile_parameter`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2911090 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `staticdnsentry`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
INSERT INTO `status` VALUES (1,'OFFLINE','Edge: Puts server in CCR config file in this state, but CCR will never route traffic to it. Mid: Server will not be included in parent.config files for its edge caches','2013-02-13 16:34:29'),(2,'ONLINE','Edge: Puts server in CCR config file in this state, and CCR will always route traffic to it. Mid: Server will be included in parent.config files for its edges','2013-02-13 16:34:29'),(3,'REPORTED','Edge: Puts server in CCR config file in this state, and CCR will adhere to the health protocol. Mid: N/A for now','2013-02-13 16:34:29'),(4,'ADMIN_DOWN','Temporary down. Edge: XMPP client will send status OFFLINE to CCR, otherwise similar to REPORTED. Mid: Server will not be included in parent.config files for its edge caches','2013-02-13 16:34:29'),(5,'CCR_IGNORE','Edge: 12M will not include caches in this state in CCR config files. Mid: N/A for now','2013-02-13 16:34:29');
...
-- Dump completed on 2014-09-17 19:46:03
