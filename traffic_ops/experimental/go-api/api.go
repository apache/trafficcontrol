...
/*
 This module was created in order to POC the concept of API Gateway between the different modules of Traffic-Ops, 
 specifically Old perl Traffic-Ops, and new (go?) one.
 It launches up an RESTful server and supplies API towards Traffic-Ops DB.
