...
ok $t->get_ok('/datadeliveryservice')->status_is(200)->json_is( '/4/dscp' => '41' )->json_is( '/4/active' => '0' )
	->json_is( '/4/profile_description' => 'mid description' )->json_is( '/4/org_server_fqdn' => 'http://update.knutsel.com' )
	->json_is( '/4/xml_id' => 'tst_xml_id_3_update' )->json_is( '/4/signed' => '0' )->json_is( '/4/qstring_ignore' => '0' )
