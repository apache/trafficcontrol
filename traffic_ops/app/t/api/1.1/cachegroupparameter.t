...
$t->get_ok("/api/1.1/cachegroupparameters.json")->status_is(200)->or( sub { diag $t->tx->res->content->asset->{content}; } )
	->json_is( '/response/cachegroupParameters/0/cachegroup', 'mid-northeast-group' )->json_is( '/response/cachegroupParameters/0/parameter', "62" )
	->json_is( '/response/cachegroupParameters/1/cachegroup', 'mid-northwest-group' )->json_is( '/response/cachegroupParameters/1/parameter', "62" );
