...
ok $t->get_ok("/api/1.2/deliveryservices_regexes.json")->status_is(200)->or( sub { diag $t->tx->res->content->asset->{content}; } )
	->json_has( '/response', 'has a response' )->json_is( '/response/0/deliveryServiceName', 'test-ds1' )
	->json_has( '/response/0/regexes/0/type', 'has a regex type' )->json_has( '/response/0/regexes/0/type', 'test-ds1' )
	->json_is( '/response/1/deliveryServiceName', 'test-ds2' )->json_has( '/response/1/regexes', 'has a second regex' )
	->json_has( '/response/1/regexes/0/type', 'has a second regex type' ), 'Query regexes';
