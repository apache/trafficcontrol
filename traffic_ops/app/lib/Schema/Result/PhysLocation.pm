...
__PACKAGE__->add_unique_constraint("idx_28816_name_unique", ["name"]);

=head2 C<idx_28816_short_name_unique>
...
__PACKAGE__->add_unique_constraint("idx_28816_short_name_unique", ["short_name"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:62qMcvSXzSiNg4ciFRNX3Q
