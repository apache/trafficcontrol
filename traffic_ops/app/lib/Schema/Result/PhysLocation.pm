...
__PACKAGE__->add_unique_constraint("idx_37407_name_unique", ["name"]);

=head2 C<idx_37407_short_name_unique>
...
__PACKAGE__->add_unique_constraint("idx_37407_short_name_unique", ["short_name"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Qg+rsVIwogamdF3nxPiY9w
