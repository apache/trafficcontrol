...
=head2 C<idx_472121_name_unique>
...
__PACKAGE__->add_unique_constraint("idx_472121_name_unique", ["name"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:58uZSM38vceC+6Pol4CO7g
