...
__PACKAGE__->result_source_instance->view_definition(
    "select s.xml_id as steering_xml_id, s.id as steering_id, s.client_steering as client_steering, t.xml_id as target_xml_id, t.id as target_id, weight from steering_target
