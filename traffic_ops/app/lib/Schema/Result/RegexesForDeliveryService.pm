...
package Schema::Result::RegexesForDeliveryService;

# this view returns the regexp set for a delivery services, ordered by type, set_number.
# to use, do 
#
# $rs = $self->db->resultset('RegexesForDeliveryService')->search({}, { bind => [ $id]});
#
...
__PACKAGE__->table("RegexesForDeliveryService");
