...
=head2 C<idx_419518_cdn_cdn_unique>
...
__PACKAGE__->add_unique_constraint("idx_419518_cdn_cdn_unique", ["name"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NE4er8pRikkal9G+Sp4YzA
