...
=head2 C<idx_28664_cdn_cdn_unique>
...
__PACKAGE__->add_unique_constraint("idx_28664_cdn_cdn_unique", ["name"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:k+cWc7WvFkCpQEHJGalT6g
