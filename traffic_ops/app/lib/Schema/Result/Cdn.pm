...
=head2 C<idx_25382_cdn_cdn_unique>
...
__PACKAGE__->add_unique_constraint("idx_25382_cdn_cdn_unique", ["name"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mcmK4OTHxn/SRKcx4AZm3w
