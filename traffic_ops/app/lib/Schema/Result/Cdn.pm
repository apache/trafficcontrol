...
=head2 C<idx_37243_cdn_cdn_unique>
...
__PACKAGE__->add_unique_constraint("idx_37243_cdn_cdn_unique", ["name"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8JZnVVJFiVSIKoc3JX1y6w
