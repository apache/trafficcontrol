...
=head2 C<idx_62394_cdn_cdn_unique>
...
__PACKAGE__->add_unique_constraint("idx_62394_cdn_cdn_unique", ["name"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nt0EhQsqdeMLydfFHmIZ5w
