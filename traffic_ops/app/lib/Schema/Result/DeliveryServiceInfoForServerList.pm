...
SELECT
    ...
    deliveryservice.session_tracking_enabled as session_tracking_enabled,
    deliveryservice.session_tracking_query_key_list as session_tracking_query_key_list
FROM
    deliveryservice
