...
=head2 C<idx_62402_ds_id_unique>
...
__PACKAGE__->add_unique_constraint("idx_62402_ds_id_unique", ["id"]);

=head2 C<idx_62402_ds_name_unique>
...
__PACKAGE__->add_unique_constraint("idx_62402_ds_name_unique", ["xml_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YEZEFl9XHXlEp3kfmDbsRA
