...
__PACKAGE__->add_unique_constraint("idx_62477_serverid", ["serverid", "description"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OeDZlDFfhRyCWh/HPbqFeQ
