...
__PACKAGE__->add_unique_constraint("idx_25475_serverid", ["serverid", "description"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:O/HTaMvgssq603JhbE9H+w
