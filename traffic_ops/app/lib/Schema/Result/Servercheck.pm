...
__PACKAGE__->add_unique_constraint("idx_62601_server", ["server"]);

=head2 C<idx_62601_ses_id_unique>
...
__PACKAGE__->add_unique_constraint("idx_62601_ses_id_unique", ["id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:K/nY2LE+xCrd1yXFoUOuVQ
