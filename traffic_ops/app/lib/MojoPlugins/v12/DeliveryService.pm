package MojoPlugins::v12::DeliveryService;
#
...
sub register {
	...
	$app->renderer->add_helper(
		v12_deliveryservice_series_name => sub {
			my $self            = shift;
			my $cdn_name        = shift;
			my $ds_name         = shift;
	...
	$app->renderer->add_helper(
		v12_deliveryservice_build_summary => sub {
			my $self        = shift;
	...
	$app->renderer->add_helper(
		v12_deliveryservice_build_series => sub {
			my $self        = shift;
			my $series_name = shift;
			my $query       = shift;
