...
my %definition_for = (
	...
	server_edge14 => {
		new   => 'Server',
		using => {
			host_name        => 'seattle-edge-14',
			domain_name      => 'ga.seattle.kabletown.net',
			tcp_port         => 80,
			xmpp_id          => 'seattle-edge-14\@ocdn.kabletown.net',
			xmpp_passwd      => 'X',
			interface_name   => 'bond0',
	...
	server_edge15 => {
		new   => 'Server',
		using => {
			host_name        => 'seattle-edge-15',
			domain_name      => 'ga.seattle.kabletown.net',
			tcp_port         => 80,
			xmpp_id          => 'seattle-edge-15\@ocdn.kabletown.net',
			xmpp_passwd      => 'X',
			interface_name   => 'bond0',
	...
	server_mid16 => {
		new   => 'Server',
		using => {
			host_name        => 'seattle-mid-16',
			domain_name      => 'ga.seattle.kabletown.net',
			tcp_port         => 80,
			xmpp_id          => 'seattle-mid-16\@ocdn.kabletown.net',
			xmpp_passwd      => 'X',
			interface_name   => 'bond0',
