...
insert into role (id, name, description, priv_level) values (1, 'disallowed','Block all access',0);
insert into role (id, name, description, priv_level) values (2, 'read-only user','Block all access', 10);
insert into role (id, name, description, priv_level) values (3, 'operations','Block all access', 20);
insert into role (id, name, description, priv_level) values (4, 'admin','super-user', 30);
insert into role (id, name, description, priv_level) values (5, 'portal','Portal User', 2);
insert into role (id, name, description, priv_level) values (6, 'migrations','database migrations user - DO NOT REMOVE', 20);
insert into role (id, name, description, priv_level) values (7, 'federation','Role for Secondary CZF', 15);
insert into tm_user (username, role,full_name) values ('portal',(select id from role where name='portal'),'Portal User');
insert into tm_user (username, role, full_name, token) values ('extension', 3, 'Extension User, DO NOT DELETE', '91504CE6-8E4A-46B2-9F9F-FE7C15228498');
...
insert into type (name, description, use_in_table) values ('CONFIG_EXTENSION', 'Extension for additional configuration file', 'to_extension');
insert into type (name, description, use_in_table) values ('STATISTIC_EXTENSION', 'Extension source for 12M graphs', 'to_extension');
insert into type (name, description, use_in_table) values ('RESOLVE4', 'federation type resolve4', 'federation');
insert into type (name, description, use_in_table) values ('RESOLVE6', 'federation type resolve6', 'federation');
insert into parameter (name, config_file, value) values ('snapshot_dir', 'regex_revalidate.config','public/Trafficserver-Snapshots/');
insert into parameter (name, config_file, value) values ('ttl_max_hours', 'regex_revalidate.config', '672');
insert into parameter (name, config_file, value) values ('ttl_min_hours', 'regex_revalidate.config', '48');
...
insert into profile (name, description) values ('RIAK_ALL', 'Riak profile for all CDNs');
insert into type (name, description, use_in_table) values ('RIAK', 'Riak keystore', 'server');

 
insert into profile (name, description) values ('TRAFFIC_STATS', 'Traffic_Stats profile');
insert into type (name, description, use_in_table) values ('TRAFFIC_STATS', 'traffic_stats server', 'server');
insert into type (name, description, use_in_table) values ('INFLUXDB', 'influxDb server', 'server');
insert into profile (name, description) values ('INFLUXDB', 'InfluxDb profile');
