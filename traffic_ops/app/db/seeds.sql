...
-- users
insert into tm_user (username, role, full_name, token) values ('extension', 2, 'Extension User, DO NOT DELETE', '91504CE6-8E4A-46B2-9F9F-FE7C15228498') ON CONFLICT DO NOTHING;
