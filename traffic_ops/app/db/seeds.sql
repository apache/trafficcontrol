...
insert into last_deleted (table_name) VALUES ('api_capability') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('asn') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('cachegroup') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('cachegroup_fallbacks') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('cachegroup_localization_method') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('cachegroup_parameter') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('capability') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('cdn') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('coordinate') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('deliveryservice') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('deliveryservice_regex') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('deliveryservice_request') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('deliveryservice_request_comment') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('deliveryservice_server') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('deliveryservice_tmuser') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('division') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('federation') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('federation_deliveryservice') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('federation_federation_resolver') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('federation_resolver') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('federation_tmuser') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('hwinfo') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('job') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('job_agent') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('job_status') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('log') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('origin') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('parameter') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('phys_location') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('profile') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('profile_parameter') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('regex') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('region') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('role') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('role_capability') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('server') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('servercheck') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('snapshot') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('staticdnsentry') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('stats_summary') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('status') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('steering_target') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('tenant') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('tm_user') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('topology') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('topology_cachegroup') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('topology_cachegroup_parents') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('to_extension') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('type') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('user_role') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('server_capability') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('server_server_capability') ON CONFLICT DO NOTHING;
insert into last_deleted (table_name) VALUES ('deliveryservices_required_capability') ON CONFLICT DO NOTHING;