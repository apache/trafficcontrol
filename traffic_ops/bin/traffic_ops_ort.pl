...
sub process_cfg_file {
	...
	elsif ($result !~ m/DO NOT EDIT - $hostname_short/) {
		($log_level >> $FATAL) && print "FATAL URL: $url has bad contents! Not trusting anything from TO, bailing!\n";
		exit 1;
	}
