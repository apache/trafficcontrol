...
const (
	...
	DeliveryServiceRequiredCapabilities
	Divisions
	Origins
	Parameters
	PhysLocations
...
var withFuncs = map[TCObj]TCObjFuncs{
	...
	DeliveryServiceRequiredCapabilities: {CreateTestDeliveryServiceRequiredCapabilities, DeleteTestDeliveryServiceRequiredCapabilities},
