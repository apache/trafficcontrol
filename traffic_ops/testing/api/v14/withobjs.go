...
const (
	...
	DeliveryServiceServerCapabilities
	Divisions
	FederationUsers
	Origins
	Parameters
...
var withFuncs = map[TCObj]TCObjFuncs{
	...
	DeliveryServiceServerCapabilities: {CreateTestDeliveryServiceServerCapabilities, DeleteTestDeliveryServiceServerCapabilities},
