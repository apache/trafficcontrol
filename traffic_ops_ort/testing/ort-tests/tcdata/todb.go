...
func (r *TCData) OpenConnection() (*sql.DB, error) {
	...
	fmt.Printf("User: %s, Password: %s, Hostname: %s, DB: %s\n", r.Config.TrafficOpsDB.User, r.Config.TrafficOpsDB.Password, r.Config.TrafficOpsDB.Hostname, r.Config.TrafficOpsDB.Name)
