...
public class CertificateCheckerTest {
	...
	public void before() throws Exception {
		...
		when(keyStoreHelper.hasCertificate("https-delivery-service")).thenReturn(true);
		...
		JSONArray x = httpsDeliveryServiceJson.optJSONArray("matchsets");
	...
	public void itReturnsTrueWhenAllHttpsDeliveryServicesHaveCertificates() throws Exception {
		...
		verify(keyStoreHelper).hasCertificate("https-delivery-service");
	}
	...
	public void itReturnsFalseWhenAnyHttpsDeliveryServiceMissingCertificates() throws Exception {
		...
		verify(keyStoreHelper).hasCertificate("bad-https-delivery-service");
	}
}
