...
// func (t StatHistoryThreadsafe) GetDeliveryServices() map[string]peer.Deliveryservice {
// 	t.m.Lock()
// 	defer func() {
// 		t.m.Unlock()
// 	}()
...
// func (t StatHistoryThreadsafe) GetCache(name string) peer.IsAvailable {
// 	t.m.Lock()
// 	defer func() {
// 		t.m.Unlock()
// 	}()
...
// func (t StatHistoryThreadsafe) GetCaches() map[string]peer.IsAvailable {
// 	t.m.Lock()
// 	defer func() {
// 		t.m.Unlock()
// 	}()
...
// func (t StatHistoryThreadsafe) GetDeliveryService(name string) peer.Deliveryservice {
// 	t.m.Lock()
// 	defer func() {
// 		t.m.Unlock()
// 	}()
...
// func (o StatHistoryThreadsafe) Set(newStatHistory peer.Crstates) {
// 	o.m.Lock()
// 	*o.crStates = newStatHistory
// 	o.m.Unlock()
// }
