...
func (t *CRStatesThreadsafe) GetDeliveryServices() map[tce.DeliveryServiceName]tc.CRStatesDeliveryService {
	t.m.RLock()
	defer t.m.RUnlock()
...
func (t *CRStatesThreadsafe) GetCache(name tce.CacheName) (available tc.IsAvailable, ok bool) {
	t.m.RLock()
...
func (t *CRStatesThreadsafe) GetCaches() map[tce.CacheName]tc.IsAvailable {
	t.m.RLock()
	defer t.m.RUnlock()
...
func (t *CRStatesThreadsafe) GetDeliveryService(name tce.DeliveryServiceName) (ds tc.CRStatesDeliveryService, ok bool) {
	t.m.RLock()
...
func (t *CRStatesThreadsafe) SetCache(cacheName tce.CacheName, available tc.IsAvailable) {
	t.m.Lock()
...
func (t *CRStatesThreadsafe) AddCache(cacheName tce.CacheName, available tc.IsAvailable) {
	t.m.Lock()
	t.crStates.Caches[cacheName] = available
	t.m.Unlock()
}
...
func (t *CRStatesThreadsafe) DeleteCache(name tce.CacheName) {
	t.m.Lock()
...
func (t *CRStatesThreadsafe) SetDeliveryService(name tce.DeliveryServiceName, ds tc.CRStatesDeliveryService) {
	t.m.Lock()
...
func (t *CRStatesThreadsafe) DeleteDeliveryService(name tce.DeliveryServiceName) {
	t.m.Lock()
...
type CRStatesPeersThreadsafe struct {
	crStates   map[tce.TrafficMonitorName]tc.CRStates
	peerStates map[tce.TrafficMonitorName]bool
	peerTimes  map[tce.TrafficMonitorName]time.Time
	peerOnline map[tce.TrafficMonitorName]bool
...
func (t *CRStatesPeersThreadsafe) SetPeers(newPeers map[tce.TrafficMonitorName]struct{}) {
	t.m.Lock()
	defer t.m.Unlock()
...
func (t *CRStatesPeersThreadsafe) GetCrstates() map[tce.TrafficMonitorName]tc.CRStates {
	t.m.RLock()
	m := map[tce.TrafficMonitorName]tc.CRStates{}
...
func copyPeerTimes(a map[tce.TrafficMonitorName]time.Time) map[tce.TrafficMonitorName]time.Time {
	m := make(map[tce.TrafficMonitorName]time.Time, len(a))
	for k, v := range a {
		m[k] = v
	}
	return m
...
func copyPeerAvailable(a map[tce.TrafficMonitorName]bool) map[tce.TrafficMonitorName]bool {
	m := make(map[tce.TrafficMonitorName]bool, len(a))
	for k, v := range a {
		m[k] = v
	}
	return m
...
func (t *CRStatesPeersThreadsafe) GetPeerAvailability(peer tce.TrafficMonitorName) bool {
	t.m.RLock()
...
func (t *CRStatesPeersThreadsafe) GetPeersOnline() map[tce.TrafficMonitorName]bool {
	t.m.RLock()
	defer t.m.RUnlock()
...
func (t *CRStatesPeersThreadsafe) GetQueryTimes() map[tce.TrafficMonitorName]time.Time {
	t.m.RLock()
	defer t.m.RUnlock()
