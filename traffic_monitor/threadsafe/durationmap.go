...
// DurationMap wraps a map[string]time.Duration in an object safe for a single writer and multiple readers
...
func (o *DurationMap) Get() map[string]time.Duration {
	o.m.RLock()
	defer o.m.RUnlock()
...
func (o *DurationMap) Set(d map[string]time.Duration) {
	o.m.Lock()
	*o.durationMap = d
	o.m.Unlock()
}
