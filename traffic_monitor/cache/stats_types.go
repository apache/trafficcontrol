...
type StatsTypeParser func(cache tce.CacheName, r io.Reader) (error, map[string]interface{}, AstatsSystem)
...
//
type StatsTypePrecomputer func(cache tce.CacheName, toData todata.TOData, stats map[string]interface{}, system AstatsSystem) PrecomputedData
