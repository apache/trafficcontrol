...
func ValidateAllPeerPollers(toClient *to.Session, includeOffline bool) (map[tce.TrafficMonitorName]error, error) {
	...
	for _, server := range servers {
		...
		errs[tce.TrafficMonitorName(server.HostName)] = ValidatePeerPoller(uri)
	}
	return errs, nil
}
