...
:encryption_key_location:   The location on-disk for the key used to encrypt secrets before they are stored.
...

	{
		"traffic_ops_golang": {
			...
			"traffic_vault_config": {
				...
				"encryption_key_location": "/opt/traffic_ops/app/conf/tv.key"
			}
		}
	}
