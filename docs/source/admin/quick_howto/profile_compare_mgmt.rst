...
*******************************
In Traffic Portal *all* users can compare the parameters of any 2 profiles side-by-side, and users with higher level permissions ("operations" or "admin") can easily add or remove parameters from each profile as necessary.
