...
**GET /api/1.2/deliveryservices**
  ...
  **Request Query Parameters**
  ...
  +-----------------+----------+--------------------------------------------------------------------------------+
  | ``exclude``     | no       | Response property to exclude. Currently only exampleURLs can be excluded.      |
  +-----------------+----------+--------------------------------------------------------------------------------+
  | ``orderby``     | no       | DS property to sort results by. xmlId is default.                              |
  +-----------------+----------+--------------------------------------------------------------------------------+
  ...
  **Response Properties**
  ...
  +--------------------------+--------+--------------------------------------------------------------------------------------------------------------------------------------+
  | ``exampleURLs``          | array  | Entry points into the CDN for this deliveryservice. This property can be expensive and can be excluded by ?exclude=exampleURLs       |
  +--------------------------+--------+--------------------------------------------------------------------------------------------------------------------------------------+
