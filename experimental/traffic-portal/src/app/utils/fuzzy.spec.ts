...
describe("fuzzyScore", () => {
	it ("scores properly", () => {
		...
		expect(fuzzyScore("foobar", pattern)).toEqual(Infinity);
		expect(fuzzyScore("", pattern)).toEqual(Infinity);
		expect(fuzzyScore("tes", pattern)).toEqual(Infinity);
		expect(fuzzyScore("est", pattern)).toEqual(Infinity);
