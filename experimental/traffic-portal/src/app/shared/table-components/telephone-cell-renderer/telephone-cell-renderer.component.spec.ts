...
describe("TelephoneCellRendererComponent", () => {
	let component: TelephoneCellRendererComponent;
	let fixture: ComponentFixture<TelephoneCellRendererComponent>;

	beforeEach(async () => {
		await TestBed.configureTestingModule({
			declarations: [ TelephoneCellRendererComponent ]
		}).compileComponents();
		fixture = TestBed.createComponent(TelephoneCellRendererComponent);
