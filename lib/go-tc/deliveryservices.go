...
func (ds DeliveryServiceV40) TLSVersionsAlerts() Alerts {
	vers := ds.TLSVersions
	return tlsVersionsAlerts(vers, Coalesce(ds.Protocol, 3))
}
...
// DowngradeToV31 converts a 4.x DS to a 3.0 DS - NOT a 3.1 DS as the name might
// otherwise imply!
...
func (ds DeliveryServiceV5) TLSVersionsAlerts() Alerts {
	return tlsVersionsAlerts(ds.TLSVersions, Coalesce(ds.Protocol, 3))
}
	...
	downgraded := DeliveryServiceV4{
		DeliveryServiceV40: DeliveryServiceV40{
			DeliveryServiceFieldsV31: DeliveryServiceFieldsV31{
				MaxRequestHeaderBytes: CopyIfNotNil(ds.MaxRequestHeaderBytes),
			},
			DeliveryServiceFieldsV30: DeliveryServiceFieldsV30{
				FirstHeaderRewrite: CopyIfNotNil(ds.FirstHeaderRewrite),
				InnerHeaderRewrite: CopyIfNotNil(ds.InnerHeaderRewrite),
				LastHeaderRewrite:  CopyIfNotNil(ds.LastHeaderRewrite),
				ServiceCategory:    CopyIfNotNil(ds.ServiceCategory),
				Topology:           CopyIfNotNil(ds.Topology),
			},
			DeliveryServiceFieldsV15: DeliveryServiceFieldsV15{
				EcsEnabled:          ds.EcsEnabled,
				RangeSliceBlockSize: CopyIfNotNil(ds.RangeSliceBlockSize),
			},
			DeliveryServiceFieldsV14: DeliveryServiceFieldsV14{
				ConsistentHashQueryParams: make([]string, len(ds.ConsistentHashQueryParams)),
				ConsistentHashRegex:       CopyIfNotNil(ds.ConsistentHashRegex),
				MaxOriginConnections:      CopyIfNotNil(ds.MaxOriginConnections),
			},
			DeliveryServiceFieldsV13: DeliveryServiceFieldsV13{
				DeepCachingType:   new(DeepCachingType),
				FQPacingRate:      CopyIfNotNil(ds.FQPacingRate),
				SigningAlgorithm:  CopyIfNotNil(ds.SigningAlgorithm),
				Tenant:            CopyIfNotNil(ds.Tenant),
				TRResponseHeaders: CopyIfNotNil(ds.TRResponseHeaders),
				TRRequestHeaders:  CopyIfNotNil(ds.TRRequestHeaders),
			},
			DeliveryServiceNullableFieldsV11: DeliveryServiceNullableFieldsV11{
				...
				CCRDNSTTL:                CopyIfNotNil(ds.CCRDNSTTL),
				CDNID:                    util.IntPtr(ds.CDNID),
				CDNName:                  CopyIfNotNil(ds.CDNName),
				CheckPath:                CopyIfNotNil(ds.CheckPath),
				DisplayName:              util.StrPtr(ds.DisplayName),
				DNSBypassCNAME:           CopyIfNotNil(ds.DNSBypassCNAME),
				DNSBypassIP:              CopyIfNotNil(ds.DNSBypassIP),
				DNSBypassIP6:             CopyIfNotNil(ds.DNSBypassIP6),
				DNSBypassTTL:             CopyIfNotNil(ds.DNSBypassTTL),
				DSCP:                     util.IntPtr(ds.DSCP),
				EdgeHeaderRewrite:        CopyIfNotNil(ds.EdgeHeaderRewrite),
				GeoLimit:                 util.IntPtr(ds.GeoLimit),
				GeoLimitRedirectURL:      CopyIfNotNil(ds.GeoLimitRedirectURL),
				GeoProvider:              util.IntPtr(ds.GeoProvider),
				GlobalMaxMBPS:            CopyIfNotNil(ds.GlobalMaxMBPS),
				GlobalMaxTPS:             CopyIfNotNil(ds.GlobalMaxTPS),
				HTTPBypassFQDN:           CopyIfNotNil(ds.HTTPBypassFQDN),
				ID:                       CopyIfNotNil(ds.ID),
				InfoURL:                  CopyIfNotNil(ds.InfoURL),
				InitialDispersion:        CopyIfNotNil(ds.InitialDispersion),
				IPV6RoutingEnabled:       CopyIfNotNil(ds.IPV6RoutingEnabled),
				LastUpdated:              TimeNoModFromTime(ds.LastUpdated),
				LogsEnabled:              util.BoolPtr(ds.LogsEnabled),
				LongDesc:                 util.StrPtr(ds.LongDesc),
				MaxDNSAnswers:            CopyIfNotNil(ds.MaxDNSAnswers),
				MidHeaderRewrite:         CopyIfNotNil(ds.MidHeaderRewrite),
				MissLat:                  CopyIfNotNil(ds.MissLat),
				MissLong:                 CopyIfNotNil(ds.MissLong),
				MultiSiteOrigin:          util.BoolPtr(ds.MultiSiteOrigin),
				OriginShield:             CopyIfNotNil(ds.OriginShield),
				OrgServerFQDN:            CopyIfNotNil(ds.OrgServerFQDN),
				ProfileDesc:              CopyIfNotNil(ds.ProfileDesc),
				ProfileID:                CopyIfNotNil(ds.ProfileID),
				ProfileName:              CopyIfNotNil(ds.ProfileName),
				Protocol:                 CopyIfNotNil(ds.Protocol),
				QStringIgnore:            CopyIfNotNil(ds.QStringIgnore),
				RangeRequestHandling:     CopyIfNotNil(ds.RangeRequestHandling),
				RegexRemap:               CopyIfNotNil(ds.RegexRemap),
				RegionalGeoBlocking:      util.BoolPtr(ds.RegionalGeoBlocking),
				RemapText:                CopyIfNotNil(ds.RemapText),
				RoutingName:              util.StrPtr(ds.RoutingName),
				Signed:                   ds.Signed,
				SSLKeyVersion:            CopyIfNotNil(ds.SSLKeyVersion),
				TenantID:                 util.IntPtr(ds.TenantID),
				Type:                     (*DSType)(CopyIfNotNil(ds.Type)),
...
func (ds DeliveryServiceV4) Upgrade() DeliveryServiceV5 {
	upgraded := DeliveryServiceV5{
		AnonymousBlockingEnabled:  CoalesceToDefault(ds.AnonymousBlockingEnabled),
		CCRDNSTTL:                 CopyIfNotNil(ds.CCRDNSTTL),
		CDNID:                     Coalesce(ds.CDNID, -1),
		CDNName:                   CopyIfNotNil(ds.CDNName),
		CheckPath:                 CopyIfNotNil(ds.CheckPath),
		ConsistentHashQueryParams: make([]string, len(ds.ConsistentHashQueryParams)),
		ConsistentHashRegex:       CopyIfNotNil(ds.ConsistentHashRegex),
		DeepCachingType:           CoalesceToDefault(ds.DeepCachingType),
		DisplayName:               CoalesceToDefault(ds.DisplayName),
		DNSBypassCNAME:            CopyIfNotNil(ds.DNSBypassCNAME),
		DNSBypassIP:               CopyIfNotNil(ds.DNSBypassIP),
		DNSBypassIP6:              CopyIfNotNil(ds.DNSBypassIP6),
		DNSBypassTTL:              CopyIfNotNil(ds.DNSBypassTTL),
		DSCP:                      Coalesce(ds.DSCP, -1),
		EcsEnabled:                ds.EcsEnabled,
		EdgeHeaderRewrite:         CopyIfNotNil(ds.EdgeHeaderRewrite),
		ExampleURLs:               nil,
		FirstHeaderRewrite:        CopyIfNotNil(ds.FirstHeaderRewrite),
		FQPacingRate:              CopyIfNotNil(ds.FQPacingRate),
		GeoLimit:                  Coalesce(ds.GeoLimit, -1),
		GeoLimitCountries:         make([]string, len(ds.GeoLimitCountries)),
		GeoLimitRedirectURL:       CopyIfNotNil(ds.GeoLimitRedirectURL),
		GeoProvider:               Coalesce(ds.GeoProvider, -1),
		GlobalMaxMBPS:             CopyIfNotNil(ds.GlobalMaxMBPS),
		GlobalMaxTPS:              CopyIfNotNil(ds.GlobalMaxTPS),
		HTTPBypassFQDN:            CopyIfNotNil(ds.HTTPBypassFQDN),
		ID:                        CopyIfNotNil(ds.ID),
		...
		IPV6RoutingEnabled:        CopyIfNotNil(ds.IPV6RoutingEnabled),
		LastHeaderRewrite:         CopyIfNotNil(ds.LastHeaderRewrite),
		LogsEnabled:               Coalesce(ds.LogsEnabled, false),
		LongDesc:                  CoalesceToDefault(ds.LongDesc),
		MatchList:                 nil,
		MaxDNSAnswers:             CopyIfNotNil(ds.MaxDNSAnswers),
		MaxOriginConnections:      CopyIfNotNil(ds.MaxOriginConnections),
		MaxRequestHeaderBytes:     CopyIfNotNil(ds.MaxRequestHeaderBytes),
		...
		MissLat:                   CopyIfNotNil(ds.MissLat),
		MissLong:                  CopyIfNotNil(ds.MissLong),
		MultiSiteOrigin:           CoalesceToDefault(ds.MultiSiteOrigin),
		OriginShield:              CopyIfNotNil(ds.OriginShield),
		OrgServerFQDN:             CopyIfNotNil(ds.OrgServerFQDN),
		ProfileDesc:               CopyIfNotNil(ds.ProfileDesc),
		ProfileID:                 CopyIfNotNil(ds.ProfileID),
		...
		RegexRemap:                CopyIfNotNil(ds.RegexRemap),
		Regional:                  ds.Regional,
		RegionalGeoBlocking:       CoalesceToDefault(ds.RegionalGeoBlocking),
		RemapText:                 CopyIfNotNil(ds.RemapText),
		RequiredCapabilities:      make([]string, len(ds.RequiredCapabilities)),
		RoutingName:               CoalesceToDefault(ds.RoutingName),
		ServiceCategory:           CopyIfNotNil(ds.ServiceCategory),
		Signed:                    ds.Signed,
		SigningAlgorithm:          CopyIfNotNil(ds.SigningAlgorithm),
		SSLKeyVersion:             CopyIfNotNil(ds.SSLKeyVersion),
		Tenant:                    CopyIfNotNil(ds.Tenant),
		TenantID:                  Coalesce(ds.TenantID, -1),
		TLSVersions:               make([]string, len(ds.TLSVersions)),
		Topology:                  CopyIfNotNil(ds.Topology),
		TRResponseHeaders:         CopyIfNotNil(ds.TRResponseHeaders),
		TRRequestHeaders:          CopyIfNotNil(ds.TRRequestHeaders),
		Type:                      (*string)(CopyIfNotNil(ds.Type)),
		TypeID:                    Coalesce(ds.TypeID, -1),
		XMLID:                     CoalesceToDefault(ds.XMLID),
	}
