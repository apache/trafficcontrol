...
// ToConcrete converts a DeliveryServiceNullable to a DeliveryService.
//
// Deprecated: Both DeliveryServiceNullable and DeliveryService are deprecated,
// so theoretically this serves no purpose.
func (ds DeliveryServiceNullableV30) ToConcrete() DeliveryService {
	ret := DeliveryService{
		DeliveryServiceV13: DeliveryServiceV13{
			DeliveryServiceV11: DeliveryServiceV11{
				Active:                   util.CoalesceToDefault(ds.Active),
				AnonymousBlockingEnabled: util.CoalesceToDefault(ds.AnonymousBlockingEnabled),
				CacheURL:                 util.CoalesceToDefault(ds.CacheURL),
				CCRDNSTTL:                util.CoalesceToDefault(ds.CCRDNSTTL),
				CDNID:                    util.CoalesceToDefault(ds.CDNID),
				CDNName:                  util.CoalesceToDefault(ds.CDNName),
				CheckPath:                util.CoalesceToDefault(ds.CheckPath),
				DeepCachingType:          util.CoalesceToDefault(ds.DeepCachingType),
				DisplayName:              util.CoalesceToDefault(ds.DisplayName),
				DNSBypassCname:           util.CoalesceToDefault(ds.DNSBypassCNAME),
				DNSBypassIP:              util.CoalesceToDefault(ds.DNSBypassIP),
				DNSBypassIP6:             util.CoalesceToDefault(ds.DNSBypassIP6),
				DNSBypassTTL:             util.CoalesceToDefault(ds.DNSBypassTTL),
				DSCP:                     util.CoalesceToDefault(ds.DSCP),
				EdgeHeaderRewrite:        util.CoalesceToDefault(ds.EdgeHeaderRewrite),
				ExampleURLs:              make([]string, len(ds.ExampleURLs)),
				GeoLimit:                 util.CoalesceToDefault(ds.GeoLimit),
				GeoProvider:              util.CoalesceToDefault(ds.GeoProvider),
				GlobalMaxMBPS:            util.CoalesceToDefault(ds.GlobalMaxMBPS),
				GlobalMaxTPS:             util.CoalesceToDefault(ds.GlobalMaxTPS),
				HTTPBypassFQDN:           util.CoalesceToDefault(ds.HTTPBypassFQDN),
				ID:                       util.CoalesceToDefault(ds.ID),
				InfoURL:                  util.CoalesceToDefault(ds.InfoURL),
				InitialDispersion:        float32(util.CoalesceToDefault(ds.InitialDispersion)),
				IPV6RoutingEnabled:       util.CoalesceToDefault(ds.IPV6RoutingEnabled),
				LastUpdated:              util.CopyIfNotNil(ds.LastUpdated),
				LogsEnabled:              util.CoalesceToDefault(ds.LogsEnabled),
				LongDesc:                 util.CoalesceToDefault(ds.LongDesc),
				LongDesc1:                util.CoalesceToDefault(ds.LongDesc1),
				LongDesc2:                util.CoalesceToDefault(ds.LongDesc2),
				MatchList:                nil,
				MaxDNSAnswers:            util.CoalesceToDefault(ds.MaxDNSAnswers),
				MidHeaderRewrite:         util.CoalesceToDefault(ds.MidHeaderRewrite),
				MissLat:                  util.CoalesceToDefault(ds.MissLat),
				MissLong:                 util.CoalesceToDefault(ds.MissLong),
				MultiSiteOrigin:          util.CoalesceToDefault(ds.MultiSiteOrigin),
				OrgServerFQDN:            util.CoalesceToDefault(ds.OrgServerFQDN),
				ProfileDesc:              util.CoalesceToDefault(ds.ProfileDesc),
				ProfileID:                util.CoalesceToDefault(ds.ProfileID),
				ProfileName:              util.CoalesceToDefault(ds.ProfileName),
				Protocol:                 util.CoalesceToDefault(ds.Protocol),
				QStringIgnore:            util.CoalesceToDefault(ds.QStringIgnore),
				RangeRequestHandling:     util.CoalesceToDefault(ds.RangeRequestHandling),
				RegexRemap:               util.CoalesceToDefault(ds.RegexRemap),
				RegionalGeoBlocking:      util.CoalesceToDefault(ds.RegionalGeoBlocking),
				RemapText:                util.CoalesceToDefault(ds.RemapText),
				RoutingName:              util.CoalesceToDefault(ds.RoutingName),
				Signed:                   ds.Signed,
				TypeID:                   util.CoalesceToDefault(ds.TypeID),
				Type:                     util.CoalesceToDefault(ds.Type),
				TRResponseHeaders:        util.CoalesceToDefault(ds.TRResponseHeaders),
				TenantID:                 util.CoalesceToDefault(ds.TenantID),
				XMLID:                    util.CoalesceToDefault(ds.XMLID),
			},
			DeepCachingType:   util.CoalesceToDefault(ds.DeepCachingType),
			FQPacingRate:      util.CoalesceToDefault(ds.FQPacingRate),
			SigningAlgorithm:  util.CoalesceToDefault(ds.SigningAlgorithm),
			Tenant:            util.CoalesceToDefault(ds.Tenant),
			TRRequestHeaders:  util.CoalesceToDefault(ds.TRRequestHeaders),
			TRResponseHeaders: util.CoalesceToDefault(ds.TRResponseHeaders),
		},
		MaxOriginConnections:      util.CoalesceToDefault(ds.MaxOriginConnections),
		ConsistentHashRegex:       util.CoalesceToDefault(ds.ConsistentHashRegex),
	...
	if ds.MatchList != nil && *ds.MatchList != nil {
