...
func ExampleDeliveryServiceRequestV30_String() {
	...
	// Output: DeliveryServiceRequestV30(Assignee=<nil>, AssigneeID=<nil>, Author="", AuthorID=<nil>, ChangeType="", CreatedAt=0001-01-01T00:00:00Z, ID=<nil>, LastEditedBy="", LastEditedByID=<nil>, LastUpdated=0001-01-01T00:00:00Z, Status="")
}

func TestDeliveryServiceRequestV30_Downgrade(t *testing.T) {
	xmlid := "xmlid"
	dsr := DeliveryServiceRequestV30{
		Assignee:       nil,
		AssigneeID:     nil,
		Author:         "author",
		AuthorID:       nil,
