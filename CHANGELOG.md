...
- Traffic Ops Golang Endpoints
  ...
  - /api/2.0/vault/bucket/:bucket/key/:key/valuebucket/:bucket/key/:key/valuebucket/:bucket/key/:key/valuebucket/:bucket/key/:key/valuebucket/:bucket/key/:key/valuebucket/:bucket/key/:key/valuebucket/:bucket/key/:key/valuebucket/:bucket/key/:key/value `GET`
