...
- Change to Traffic Stats to send data through Kafka in a flat JSON format for easier data ingestion [#6884](https://github.com/apache/trafficcontrol/issues/6884)
