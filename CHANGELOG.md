...
- [#7097](https://github.com/apache/trafficcontrol/issues/7097) *Traffic Ops* Added the `regional` field, which indicates whether `maxOriginConnections` should be per Cache Group
