...
- Traffic Ops Golang Endpoints
  ...
  - /api/1.4/deliveryservice_server_capabilities `(GET,POST,DELETE)`
...
- Added an API 1.4 endpoint, /api/1.4/deliveryservice_server_capabilities, to create, read, and delete associations between a delivery service and a server capability.
