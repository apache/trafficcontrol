...
- Closed Delivery Service Requests now keep a record of the changes they made/would have made. Refer to [the docs](https://traffic-control-cdn.readthedocs.io/en/latest/overview/delivery_service_requests.html) for specifics on the new model.
