...
psql -h $DB_SERVER -U postgres -c "CREATE USER $SRIJEET_DB_USERNAME WITH ENCRYPTED PASSWORD '$DB_USER_PASS'"
createdb $SRIJEET_DB_NAME -h $DB_SERVER -U postgres --owner $SRIJEET_DB_USERNAME
