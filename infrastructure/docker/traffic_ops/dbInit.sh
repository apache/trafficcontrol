...
psql -h $DB_SERVER -U postgres -c "CREATE USER $TV_DB_USERNAME WITH ENCRYPTED PASSWORD '$DB_USER_PASS'"
createdb $TV_DB_NAME -h $DB_SERVER -U postgres --owner $TV_DB_USERNAME
