...
#	TMP_GATEWAY="$(route -n | grep -E "^0\.0\.0\.0[[:space:]]" | cut -f1 -d" " --complement | sed -e 's/^[ \t]*//' | cut -f1 -d" ")"
	...
	TMP_SERVER_PROFILE_ID="$(curl -s -k -X GET -H "Cookie: mojolicious=$TMP_TO_COOKIE" $TRAFFIC_OPS_URI/api/1.2/profiles.json | python -c 'import json,sys;obj=json.load(sys.stdin);match=[x["id"] for x in obj["response"] if x["name"]=="CCR_CDN"]; print match[0]')"
	...
	curl -v -k -X POST -H "Cookie: mojolicious=$TMP_TO_COOKIE" --data-urlencode "ds.xml_id=ds2-live" --data-urlencode "ds.display_name=DS2 Live" --data-urlencode "ds.cdn_id=$TMP_CDN_ID" --data-urlencode "ds.type=$TMP_DELIVERY_SERVICE_LIVE_TYPE_ID"  --data-urlencode "ds.protocol=0" --data-urlencode "ds.dscp=0" --data-urlencode "ds.signed=0" --data-urlencode "ds.qstring_ignore=0" --data-urlencode "ds.geo_limit=0" --data-urlencode "ds.http_bypass_fqdn=" --data-urlencode "ds.initial_dispersion=1" --data-urlencode "ds.ipv6_routing_enabled=0" --data-urlencode "ds.range_request_handling=0" --data-urlencode "ds.dns_bypass_ip=" --data-urlencode "ds.dns_bypass_ip6=" --data-urlencode "ds.dns_bypass_cname=" --data-urlencode "ds.dns_bypass_ttl=30" --data-urlencode "ds.max_dns_answers=" --data-urlencode "ds.ccr_dns_ttl=30" --data-urlencode "ds.org_server_fqdn=$ORIGIN_URI" --data-urlencode "ds.multi_site_origin=0" --data-urlencode "ds.profile=$TMP_SERVER_PROFILE_ID" --data-urlencode "ds.global_max_mbps=" --data-urlencode "ds.global_max_tps=" --data-urlencode "ds.miss_lat=41.881944" --data-urlencode "ds.miss_long=-87.627778" --data-urlencode "ds.edge_header_rewrite=" --data-urlencode "ds.mid_header_rewrite=" --data-urlencode "ds.tr_response_headers=" --data-urlencode "ds.regex_remap=" --data-urlencode "ds.cacheurl=" --data-urlencode "ds.remap_text=" --data-urlencode "ds.long_desc=" --data-urlencode "ds.long_desc_1=" --data-urlencode "ds.long_desc_2=" --data-urlencode "ds.info_url=" --data-urlencode "ds.check_path=" --data-urlencode "ds.origin_shield=" --data-urlencode "ds.active=1" --data-urlencode "ds.regex=_____" --data-urlencode "re_type_0=HOST_REGEXP" --data-urlencode "re_order_0=0" --data-urlencode "re_re_0=.*\\.ds2-live\\..*" $TRAFFIC_OPS_URI/ds/create
	...
	curl -v -k -X POST -H "Cookie: mojolicious=$TMP_TO_COOKIE" --data-urlencode "ds.xml_id=c3-service" --data-urlencode "ds.display_name=C3 Service" --data-urlencode "ds.cdn_id=$TMP_CDN_ID" --data-urlencode "ds.type=$TMP_DELIVERY_SERVICE_HTTP_TYPE_ID"  --data-urlencode "ds.protocol=0" --data-urlencode "ds.dscp=0" --data-urlencode "ds.signed=0" --data-urlencode "ds.qstring_ignore=0" --data-urlencode "ds.geo_limit=0" --data-urlencode "ds.http_bypass_fqdn=" --data-urlencode "ds.initial_dispersion=1" --data-urlencode "ds.ipv6_routing_enabled=0" --data-urlencode "ds.range_request_handling=0" --data-urlencode "ds.dns_bypass_ip=" --data-urlencode "ds.dns_bypass_ip6=" --data-urlencode "ds.dns_bypass_cname=" --data-urlencode "ds.dns_bypass_ttl=30" --data-urlencode "ds.max_dns_answers=" --data-urlencode "ds.ccr_dns_ttl=30" --data-urlencode "ds.org_server_fqdn=$ORIGIN_URI" --data-urlencode "ds.multi_site_origin=0" --data-urlencode "ds.profile=$TMP_SERVER_PROFILE_ID" --data-urlencode "ds.global_max_mbps=" --data-urlencode "ds.global_max_tps=" --data-urlencode "ds.miss_lat=41.881944" --data-urlencode "ds.miss_long=-87.627778" --data-urlencode "ds.edge_header_rewrite=" --data-urlencode "ds.mid_header_rewrite=" --data-urlencode "ds.tr_response_headers=" --data-urlencode "ds.regex_remap=" --data-urlencode "ds.cacheurl=" --data-urlencode "ds.remap_text=" --data-urlencode "ds.long_desc=" --data-urlencode "ds.long_desc_1=" --data-urlencode "ds.long_desc_2=" --data-urlencode "ds.info_url=" --data-urlencode "ds.check_path=" --data-urlencode "ds.origin_shield=" --data-urlencode "ds.active=1" --data-urlencode "ds.regex=_____" --data-urlencode "re_type_1=HOST_REGEXP" --data-urlencode "re_order_1=0" --data-urlencode "re_re_1=.*\\.ds2\\..*" $TRAFFIC_OPS_URI/ds/create
	...
	TMP_EDGES="$(curl -s -k -X GET -H "Cookie: mojolicious=$TMP_TO_COOKIE" $TRAFFIC_OPS_URI/api/1.2/servers.json | python -c 'import json,sys;obj=json.load(sys.stdin);match=[x["id"] for x in obj["response"] if x["type"]=="EDGE"]; print "\n".join(match)')"
