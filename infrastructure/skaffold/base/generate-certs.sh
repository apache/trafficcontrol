...
export X509_CA_NAME=CIAB-CA
export X509_CA_COUNTRY=US
export X509_CA_STATE=Colorado
export X509_CA_CITY=Denver
export X509_CA_COMPANY=NotComcast
export X509_CA_ORG=CDN-in-a-Box
export X509_CA_ORGUNIT=CDN-in-a-Box
export X509_CA_EMAIL=no-reply@infra.ciab.test
export X509_CA_DIGEST=sha256
export X509_CA_DURATION_DAYS=365
export X509_CA_KEYTYPE=rsa
export X509_CA_KEYSIZE=4096
export X509_CA_UMASK=0000
export X509_CA_DIR=/shared/ssl
export X509_CA_PERSIST_DIR=/ca
export X509_CA_ENV_FILE=/shared/ssl/environemnt
