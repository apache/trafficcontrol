...
endpoints="cdns types divisions regions phys_locations tenants users cachegroups profiles parameters server_capabilities servers topologies deliveryservices server_server_capabilities deliveryservice_servers"
